...
describe('Suppliers Page', () => {
  ...
  describe('Loading State', () => {
    it('should display loading state while data is fetching', () => {
      vi.mocked(useSupplierDetails).mockReturnValue({
        ...
        isFetching: true,
        refetch: vi.fn(),
      } as ReturnType<typeof useSupplierDetails>);

      render(<Suppliers />, { wrapper: createWrapper() });

      expect(screen.getByText('Loading Supplier Data')).toBeInTheDocument();
      expect(screen.getByText('Analyzing supplier metrics...')).toBeInTheDocument();
    });
  });
  ...
  describe('Error State', () => {
    it('should display error state when data fetching fails', () => {
      ...
      expect(screen.getByText('Failed to load supplier analysis. Please try again.')).toBeInTheDocument();
    });
  });
  ...
  describe('Empty State', () => {
    it('should display empty state when no supplier data exists', () => {
      ...
      expect(screen.getByText('Upload your procurement data to see supplier analysis.')).toBeInTheDocument();
    });
  ...
  describe('Data Display', () => {
    ...
    it('should display page header', () => {
      ...
      expect(screen.getByText('Analyze vendor performance and spending patterns')).toBeInTheDocument();
    });
    ...
    it('should display charts', () => {
      ...
      expect(screen.getByText('Spend Distribution by Supplier')).toBeInTheDocument();
  ...
  describe('Search Filtering', () => {
    ...
    it('should render search input', () => {
      ...
      const searchInput = screen.getByPlaceholderText('Search suppliers by name...');
    ...
    it('should clear search when clear button is clicked', async () => {
      ...
      const searchInput = screen.getByPlaceholderText('Search suppliers by name...') as HTMLInputElement;
  ...
  describe('HHI Risk Level Styling', () => {
    it('should apply green styling for low HHI risk', () => {
      vi.mocked(useSupplierDetails).mockReturnValue({
        data: {
          ...mockSupplierData,
          summary: { ...mockSupplierData.summary, hhi_risk_level: 'low' as const },
        },
        isLoading: false,
        error: null,
        isError: false,
    ...
    it('should apply red styling for high HHI risk', () => {
      vi.mocked(useSupplierDetails).mockReturnValue({
        data: {
          ...mockSupplierData,
          summary: { ...mockSupplierData.summary, hhi_risk_level: 'high' as const },
        },
        isLoading: false,
        error: null,
        isError: false,
