...
describe('API Client', () => {
  ...
  describe('authAPI', () => {
    ...
    describe('changePassword', () => {
      it('should call POST /auth/change-password/ with password data', async () => {
        ...
        const mockResponse = createMockResponse({ message: 'Password changed' });
        mockAxios.post.mockResolvedValueOnce(mockResponse);

        await authAPI.changePassword(passwordData);

        expect(mockAxios.post).toHaveBeenCalledWith('/auth/change-password/', passwordData);
      });
    });
    ...
    describe('updatePreferences', () => {
      it('should call PATCH /auth/preferences/ with partial data', async () => {
        ...
        const mockResponse = createMockResponse({ theme: 'dark', notifications: true });
        mockAxios.patch.mockResolvedValueOnce(mockResponse);

        await authAPI.updatePreferences(prefs);

        expect(mockAxios.patch).toHaveBeenCalledWith('/auth/preferences/', prefs);
      });
    });
    ...
    describe('getUserOrganizations', () => {
      it('should call GET /auth/user/organizations/', async () => {
        const mockResponse = createMockResponse({
          organizations: [{ id: 1, organization_name: 'Test Org', role: 'admin' }],
          count: 1,
        });
        mockAxios.get.mockResolvedValueOnce(mockResponse);
    ...
    describe('switchOrganization', () => {
      it('should call POST /auth/user/organizations/:id/switch/', async () => {
        ...
        expect(mockAxios.post).toHaveBeenCalledWith('/auth/user/organizations/2/switch/');
      });
    });
  });
  ...
  describe('procurementAPI', () => {
    describe('Suppliers', () => {
      ...
      it('getSupplier should call GET /procurement/suppliers/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/procurement/suppliers/1/', {
          params: {},
        });
      });
      ...
      it('createSupplier should call POST /procurement/suppliers/', async () => {
        ...
        const mockResponse = createMockResponse({ id: 1, name: 'New Supplier' });
        mockAxios.post.mockResolvedValueOnce(mockResponse);

        await procurementAPI.createSupplier(supplierData);

        expect(mockAxios.post).toHaveBeenCalledWith('/procurement/suppliers/', supplierData);
      });

      it('updateSupplier should call PATCH /procurement/suppliers/:id/', async () => {
        const updateData = { name: 'Updated Supplier' };
        const mockResponse = createMockResponse({ id: 1, name: 'Updated Supplier' });
        mockAxios.patch.mockResolvedValueOnce(mockResponse);

        await procurementAPI.updateSupplier(1, updateData);

        expect(mockAxios.patch).toHaveBeenCalledWith('/procurement/suppliers/1/', updateData);
      });
      ...
      it('deleteSupplier should call DELETE /procurement/suppliers/:id/', async () => {
        ...
        expect(mockAxios.delete).toHaveBeenCalledWith('/procurement/suppliers/1/');
      });
    });
    ...
    describe('Categories', () => {
      ...
      it('getCategory should call GET /procurement/categories/:id/', async () => {
        const mockResponse = createMockResponse({ id: 1, name: 'Office Supplies' });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await procurementAPI.getCategory(1);

        expect(mockAxios.get).toHaveBeenCalledWith('/procurement/categories/1/', {
          params: {},
        });
      });
      ...
      it('createCategory should call POST /procurement/categories/', async () => {
        ...
        const mockResponse = createMockResponse({ id: 1, name: 'New Category' });
        mockAxios.post.mockResolvedValueOnce(mockResponse);

        await procurementAPI.createCategory(categoryData);

        expect(mockAxios.post).toHaveBeenCalledWith('/procurement/categories/', categoryData);
      });

      it('updateCategory should call PATCH /procurement/categories/:id/', async () => {
        const updateData = { name: 'Updated Category' };
        const mockResponse = createMockResponse({ id: 1, name: 'Updated Category' });
        mockAxios.patch.mockResolvedValueOnce(mockResponse);

        await procurementAPI.updateCategory(1, updateData);

        expect(mockAxios.patch).toHaveBeenCalledWith('/procurement/categories/1/', updateData);
      });
      ...
      it('deleteCategory should call DELETE /procurement/categories/:id/', async () => {
        ...
        expect(mockAxios.delete).toHaveBeenCalledWith('/procurement/categories/1/');
      });
    });
    ...
    describe('Transactions', () => {
      it('getTransactions should call GET /procurement/transactions/', async () => {
        ...
        await procurementAPI.getTransactions({ supplier: 1, start_date: '2024-01-01' });

        expect(mockAxios.get).toHaveBeenCalledWith('/procurement/transactions/', {
      ...
      it('getTransaction should call GET /procurement/transactions/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/procurement/transactions/1/', {
          params: {},
        });
      });
      ...
      it('createTransaction should call POST /procurement/transactions/', async () => {
        ...
        expect(mockAxios.post).toHaveBeenCalledWith('/procurement/transactions/', transactionData);
      });
      ...
      it('updateTransaction should call PATCH /procurement/transactions/:id/', async () => {
        ...
        expect(mockAxios.patch).toHaveBeenCalledWith('/procurement/transactions/1/', updateData);
      });
      ...
      it('deleteTransaction should call DELETE /procurement/transactions/:id/', async () => {
        ...
        expect(mockAxios.delete).toHaveBeenCalledWith('/procurement/transactions/1/');
      });
      ...
      it('bulkDelete should call POST /procurement/transactions/bulk_delete/', async () => {
        const mockResponse = createMockResponse({ deleted: 5, message: 'Deleted' });
        mockAxios.post.mockResolvedValueOnce(mockResponse);

        await procurementAPI.bulkDelete([1, 2, 3, 4, 5]);

        expect(mockAxios.post).toHaveBeenCalledWith('/procurement/transactions/bulk_delete/', {
          ids: [1, 2, 3, 4, 5],
        });
      });
      ...
      it('exportCSV should call GET /procurement/transactions/export/ with blob responseType', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/procurement/transactions/export/', {
  ...
  describe('analyticsAPI', () => {
    describe('Overview & Basic Analytics', () => {
      it('getOverview should call GET /analytics/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/overview/', { params: {} });
      });
      ...
      it('getSpendByCategory should call GET /analytics/spend-by-category/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/spend-by-category/', { params: {} });
      });
      ...
      it('getCategoryDetails should call GET /analytics/categories/detailed/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/categories/detailed/', { params: {} });
      });
      ...
      it('getSpendBySupplier should call GET /analytics/spend-by-supplier/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/spend-by-supplier/', { params: {} });
      });
      ...
      it('getSupplierDetails should call GET /analytics/suppliers/detailed/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/suppliers/detailed/', { params: {} });
      });
      ...
      it('getMonthlyTrend should call GET /analytics/monthly-trend/ with months param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/monthly-trend/', {
          params: { months: 6 },
        });
      });
    });
    ...
    describe('Pareto Analysis', () => {
      it('getParetoAnalysis should call GET /analytics/pareto/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/pareto/', { params: {} });
      });
      ...
      it('getSupplierDrilldown should call GET /analytics/pareto/supplier/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/pareto/supplier/1/', { params: {} });
      });
    });
    ...
    describe('Tail Spend Analysis', () => {
      ...
      it('getDetailedTailSpend should call GET /analytics/tail-spend/detailed/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/tail-spend/detailed/', {
      ...
      it('getTailSpendCategoryDrilldown should call GET /analytics/tail-spend/category/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/tail-spend/category/1/', {
      ...
      it('getTailSpendVendorDrilldown should call GET /analytics/tail-spend/vendor/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/tail-spend/vendor/1/', {
          params: { threshold: 50000 },
        });
      });
    });
    ...
    describe('Stratification', () => {
      it('getStratification should call GET /analytics/stratification/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/stratification/', { params: {} });
      });
      ...
      it('getDetailedStratification should call GET /analytics/stratification/detailed/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/stratification/detailed/', { params: {} });
      });
      ...
      it('getSegmentDrilldown should call GET /analytics/stratification/segment/:name/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/stratification/segment/strategic/', { params: {} });
      });
      ...
      it('getBandDrilldown should encode band name in URL', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/stratification/band/%2410K-%2450K/', { params: {} });
      });
    });
    ...
    describe('Seasonality', () => {
      it('getSeasonality should call GET /analytics/seasonality/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/seasonality/', { params: {} });
      });
      ...
      it('getDetailedSeasonality should call with use_fiscal_year param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/seasonality/detailed/', {
      ...
      it('getSeasonalityCategoryDrilldown should call with category ID and fiscal year', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/seasonality/category/1/', {
    ...
    describe('Year-over-Year', () => {
      it('getYearOverYear should call GET /analytics/year-over-year/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/year-over-year/', { params: {} });
      });
      ...
      it('getDetailedYearOverYear should call with year params', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/year-over-year/detailed/', {
      ...
      it('getYoYCategoryDrilldown should call with category ID and years', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/year-over-year/category/1/', {
          params: { use_fiscal_year: true, year1: 2023, year2: 2024 },
        });
      });
      ...
      it('getYoYSupplierDrilldown should call with supplier ID and years', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/year-over-year/supplier/1/', {
    ...
    describe('Consolidation', () => {
      it('getConsolidation should call GET /analytics/consolidation/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/consolidation/', { params: {} });
      });
    });
    ...
    describe('AI Insights', () => {
      it('getAIInsights should call GET /analytics/ai-insights/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/ai-insights/', { params: {} });
      });
      ...
      it('getAIInsightsCost should call GET /analytics/ai-insights/cost/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/ai-insights/cost/', { params: {} });
      });
      ...
      it('getAIInsightsRisk should call GET /analytics/ai-insights/risk/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/ai-insights/risk/', { params: {} });
      });
      ...
      it('getAIInsightsAnomalies should call with sensitivity param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/ai-insights/anomalies/', {
    ...
    describe('Predictive Analytics', () => {
      it('getSpendingForecast should call with months param', async () => {
        const mockResponse = createMockResponse({ forecast: [], trend: {}, model_accuracy: {} });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await analyticsAPI.getSpendingForecast(12);

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/predictions/spending/', {
          params: { months: 12 },
        });
      });
      ...
      it('getCategoryForecast should call with category ID and months', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/predictions/category/1/', {
          params: { months: 6 },
        });
      });
      ...
      it('getSupplierForecast should call with supplier ID and months', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/predictions/supplier/1/', {
          params: { months: 6 },
        });
      });
      ...
      it('getTrendAnalysis should call GET /analytics/predictions/trends/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/predictions/trends/', { params: {} });
      });
      ...
      it('getBudgetProjection should call with annual_budget param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/predictions/budget/', {
    ...
    describe('Contract Analytics', () => {
      it('getContractOverview should call GET /analytics/contracts/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/overview/', { params: {} });
      });
      ...
      it('getContracts should call GET /analytics/contracts/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/', { params: {} });
      });
      ...
      it('getContractDetail should call GET /analytics/contracts/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/1/', { params: {} });
      });

      it('getExpiringContracts should call with days param', async () => {
        const mockResponse = createMockResponse({ contracts: [], count: 0, days_threshold: 90 });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await analyticsAPI.getExpiringContracts(60);

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/expiring/', {
          params: { days: 60 },
        });
      });
      ...
      it('getContractPerformance should call GET /analytics/contracts/:id/performance/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/1/performance/', { params: {} });
      });

      it('getContractSavings should call GET /analytics/contracts/savings/', async () => {
        const mockResponse = createMockResponse({ opportunities: [], total_potential_savings: 0 });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await analyticsAPI.getContractSavings();

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/savings/', { params: {} });
      });

      it('getContractRenewals should call GET /analytics/contracts/renewals/', async () => {
        const mockResponse = createMockResponse({ recommendations: [], count: 0 });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await analyticsAPI.getContractRenewals();

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/renewals/', { params: {} });
      });
      ...
      it('getContractVsActual should call GET /analytics/contracts/vs-actual/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/vs-actual/', {
      ...
      it('getContractVsActual without contract ID should not include contract_id param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/contracts/vs-actual/', { params: {} });
      });
    });
    ...
    describe('Compliance & Maverick Spend', () => {
      it('getComplianceOverview should call GET /analytics/compliance/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/compliance/overview/', { params: {} });
      });
      ...
      it('getMaverickSpendAnalysis should call GET /analytics/compliance/maverick-spend/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/compliance/maverick-spend/', { params: {} });
      });
      ...
      it('getPolicyViolations should call with filters', async () => {
        ...
        await analyticsAPI.getPolicyViolations({ resolved: false, severity: 'high', limit: 10 });

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/compliance/violations/', {
      ...
      it('getViolationTrends should call with months param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/compliance/trends/', {
          params: { months: 6 },
        });
      });
      ...
      it('getSupplierComplianceScores should call GET /analytics/compliance/supplier-scores/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/compliance/supplier-scores/', { params: {} });
      });
      ...
      it('getSpendingPolicies should call GET /analytics/compliance/policies/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/compliance/policies/', { params: {} });
      });
    });
  });
  ...
  describe('reportsAPI', () => {
    describe('Templates', () => {
      it('getTemplates should call GET /reports/templates/', async () => {
        const mockResponse = createMockResponse([
          { id: 'exec', name: 'Executive Summary', report_type: 'executive_summary' },
        ]);
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await reportsAPI.getTemplates();

        expect(mockAxios.get).toHaveBeenCalledWith('/reports/templates/', { params: {} });
      });

      it('getTemplate should call GET /reports/templates/:id/', async () => {
        const mockResponse = createMockResponse({ id: 'exec', name: 'Executive Summary' });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await reportsAPI.getTemplate('exec');

        expect(mockAxios.get).toHaveBeenCalledWith('/reports/templates/exec/', { params: {} });
      });
    });
    ...
    describe('Report Generation', () => {
      it('generate should call POST /reports/generate/ with report data', async () => {
        ...
        const mockResponse = createMockResponse({ id: 'report-123', status: 'generating' });
        mockAxios.post.mockResolvedValueOnce(mockResponse);

        await reportsAPI.generate(reportData);

        expect(mockAxios.post).toHaveBeenCalledWith('/reports/generate/', reportData, { params: {} });
      });
      ...
      it('preview should call POST /reports/preview/', async () => {
        ...
        const mockResponse = createMockResponse({ overview: {}, _preview: true });
        mockAxios.post.mockResolvedValueOnce(mockResponse);

        await reportsAPI.preview(reportData);

        expect(mockAxios.post).toHaveBeenCalledWith('/reports/preview/', reportData, { params: {} });
      });
    });

    describe('Report List and Detail', () => {
      it('getReports should call GET /reports/ with filters', async () => {
        const mockResponse = createMockResponse({ results: [], total: 0, limit: 20, offset: 0 });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await reportsAPI.getReports({ status: 'completed', report_type: 'spend_analysis' });
      ...
      it('getReport should call GET /reports/:id/', async () => {
        const mockResponse = createMockResponse({ id: 'report-123', name: 'Q4 Summary' });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await reportsAPI.getReport('report-123');

        expect(mockAxios.get).toHaveBeenCalledWith('/reports/report-123/', { params: {} });
      });

      it('getStatus should call GET /reports/:id/status/', async () => {
        const mockResponse = createMockResponse({ id: 'report-123', status: 'completed' });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await reportsAPI.getStatus('report-123');

        expect(mockAxios.get).toHaveBeenCalledWith('/reports/report-123/status/', { params: {} });
      });
      ...
      it('deleteReport should call DELETE /reports/:id/delete/', async () => {
        ...
        expect(mockAxios.delete).toHaveBeenCalledWith('/reports/report-123/delete/', { params: {} });
      });
    });
    ...
    describe('Report Download', () => {
      it('download should call GET /reports/:id/download/ with output_format', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/reports/report-123/download/', {
    ...
    describe('Sharing', () => {
      it('share should call POST /reports/:id/share/', async () => {
        ...
        expect(mockAxios.post).toHaveBeenCalledWith('/reports/report-123/share/', shareData, { params: {} });
      });
    });
    ...
    describe('Scheduled Reports', () => {
      it('getSchedules should call GET /reports/schedules/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/reports/schedules/', { params: {} });
      });
      ...
      it('createSchedule should call POST /reports/schedules/', async () => {
        ...
        expect(mockAxios.post).toHaveBeenCalledWith('/reports/schedules/', scheduleData, { params: {} });
      });
      ...
      it('getSchedule should call GET /reports/schedules/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/reports/schedules/schedule-123/', { params: {} });
      });
      ...
      it('updateSchedule should call PUT /reports/schedules/:id/', async () => {
        ...
        expect(mockAxios.put).toHaveBeenCalledWith('/reports/schedules/schedule-123/', updateData, { params: {} });
      });
      ...
      it('deleteSchedule should call DELETE /reports/schedules/:id/', async () => {
        ...
        expect(mockAxios.delete).toHaveBeenCalledWith('/reports/schedules/schedule-123/', { params: {} });
      });

      it('runScheduleNow should call POST /reports/schedules/:id/run-now/', async () => {
        const mockResponse = createMockResponse({ message: 'Started', id: 'report-456' });
        mockAxios.post.mockResolvedValueOnce(mockResponse);

        await reportsAPI.runScheduleNow('schedule-123');

        expect(mockAxios.post).toHaveBeenCalledWith('/reports/schedules/schedule-123/run-now/', {}, { params: {} });
      });
    });
  });
  ...
  describe('p2pAnalyticsAPI', () => {
    describe('Cycle Time Analysis', () => {
      it('getCycleOverview should call GET /analytics/p2p/cycle-overview/', async () => {
        const mockResponse = createMockResponse({ stages: {}, total_cycle: {}, summary: {} });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await p2pAnalyticsAPI.getCycleOverview();

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/p2p/cycle-overview/', { params: {} });
      });
      ...
      it('getCycleByCategory should call GET /analytics/p2p/cycle-by-category/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/p2p/cycle-by-category/', { params: {} });
      });
      ...
      it('getCycleBySupplier should call GET /analytics/p2p/cycle-by-supplier/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/p2p/cycle-by-supplier/', { params: {} });
      });
      ...
      it('getCycleTrends should call with months param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/p2p/cycle-trends/', {
          params: { months: 6 },
        });
      });
      ...
      it('getBottlenecks should call GET /analytics/p2p/bottlenecks/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/p2p/bottlenecks/', { params: {} });
      });

      it('getProcessFunnel should call with months param', async () => {
        const mockResponse = createMockResponse({ stages: [], drop_off_points: [] });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await p2pAnalyticsAPI.getProcessFunnel(24);

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/p2p/process-funnel/', {
          params: { months: 24 },
        });
      });

      it('getStageDrilldown should call GET /analytics/p2p/stage-drilldown/:stage/', async () => {
        const mockResponse = createMockResponse({ stage: 'pr_to_po', slowest_documents: [] });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await p2pAnalyticsAPI.getStageDrilldown('pr_to_po');

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/p2p/stage-drilldown/pr_to_po/', { params: {} });
      });
    });
    ...
    describe('3-Way Matching', () => {
      it('getMatchingOverview should call GET /analytics/matching/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/matching/overview/', { params: {} });
      });

      it('getMatchingExceptions should call with filters', async () => {
        const mockResponse = createMockResponse({ exceptions: [], count: 0, filters: {} });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await p2pAnalyticsAPI.getMatchingExceptions({ status: 'open', exception_type: 'price_variance', limit: 50 });

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/matching/exceptions/', {
          params: { status: 'open', exception_type: 'price_variance', limit: 50 },
        });
      });
      ...
      it('getExceptionsByType should call GET /analytics/matching/exceptions-by-type/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/matching/exceptions-by-type/', { params: {} });
      });
      ...
      it('getExceptionsBySupplier should call GET /analytics/matching/exceptions-by-supplier/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/matching/exceptions-by-supplier/', { params: {} });
      });
      ...
      it('getPriceVarianceAnalysis should call GET /analytics/matching/price-variance/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/matching/price-variance/', { params: {} });
      });
      ...
      it('getQuantityVarianceAnalysis should call GET /analytics/matching/quantity-variance/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/matching/quantity-variance/', { params: {} });
      });

      it('getInvoiceMatchDetail should call GET /analytics/matching/invoice/:id/', async () => {
        const mockResponse = createMockResponse({ invoice: {}, purchase_order: null, goods_receipt: null });
        mockAxios.get.mockResolvedValueOnce(mockResponse);

        await p2pAnalyticsAPI.getInvoiceMatchDetail(123);

        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/matching/invoice/123/', { params: {} });
      });

      it('resolveException should call POST /analytics/matching/invoice/:id/resolve/', async () => {
        const mockResponse = createMockResponse({ invoice_id: 123, resolved: true });
        mockAxios.post.mockResolvedValueOnce(mockResponse);
      ...
      it('bulkResolveExceptions should call POST /analytics/matching/exceptions/bulk-resolve/', async () => {
        const mockResponse = createMockResponse({ resolved_count: 3, failed_count: 0 });
        mockAxios.post.mockResolvedValueOnce(mockResponse);
    ...
    describe('Invoice Aging / AP Analysis', () => {
      it('getAgingOverview should call GET /analytics/aging/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/aging/overview/', { params: {} });
      });
      ...
      it('getAgingBySupplier should call GET /analytics/aging/by-supplier/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/aging/by-supplier/', { params: {} });
      });
      ...
      it('getPaymentTermsCompliance should call GET /analytics/aging/payment-terms-compliance/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/aging/payment-terms-compliance/', { params: {} });
      });
      ...
      it('getDPOTrends should call with months param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/aging/dpo-trends/', {
          params: { months: 6 },
        });
      });
      ...
      it('getCashFlowForecast should call with weeks param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/aging/cash-forecast/', {
          params: { weeks: 8 },
        });
      });
    });
    ...
    describe('Purchase Requisitions', () => {
      it('getPROverview should call GET /analytics/requisitions/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/requisitions/overview/', { params: {} });
      });
      ...
      it('getPRApprovalAnalysis should call GET /analytics/requisitions/approval-analysis/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/requisitions/approval-analysis/', { params: {} });
      });
      ...
      it('getPRByDepartment should call GET /analytics/requisitions/by-department/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/requisitions/by-department/', { params: {} });
      });
      ...
      it('getPRPending should call with limit param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/requisitions/pending/', {
          params: { limit: 100 },
        });
      });
      ...
      it('getPRDetail should call GET /analytics/requisitions/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/requisitions/1/', { params: {} });
      });
    });
    ...
    describe('Purchase Orders', () => {
      it('getPOOverview should call GET /analytics/purchase-orders/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/purchase-orders/overview/', { params: {} });
      });
      ...
      it('getPOLeakage should call GET /analytics/purchase-orders/leakage/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/purchase-orders/leakage/', { params: {} });
      });
      ...
      it('getPOAmendments should call GET /analytics/purchase-orders/amendments/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/purchase-orders/amendments/', { params: {} });
      });
      ...
      it('getPOBySupplier should call GET /analytics/purchase-orders/by-supplier/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/purchase-orders/by-supplier/', { params: {} });
      });
      ...
      it('getPODetail should call GET /analytics/purchase-orders/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/purchase-orders/1/', { params: {} });
      });
    });
    ...
    describe('Supplier Payment Performance', () => {
      it('getSupplierPaymentsOverview should call GET /analytics/supplier-payments/overview/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/supplier-payments/overview/', { params: {} });
      });
      ...
      it('getSupplierPaymentsScorecard should call with limit param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/supplier-payments/scorecard/', {
          params: { limit: 100 },
        });
      });
      ...
      it('getSupplierPaymentDetail should call GET /analytics/supplier-payments/:id/', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/supplier-payments/1/', { params: {} });
      });
      ...
      it('getSupplierPaymentHistory should call with months param', async () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('/analytics/supplier-payments/1/history/', {
          params: { months: 24 },
        });
      });
    });
  ...
  describe('Error Handling', () => {
    ...
    it('should reject with error when POST fails', async () => {
      ...
      await expect(authAPI.login({ username: 'test', password: 'test' })).rejects.toThrow('Server Error');
    });
  });
});
