...
export const handlers = [
  ...
  http.get(`${API_URL}/analytics/pareto/detailed/`, () => {
    return HttpResponse.json({
      suppliers: [
        { id: 1, name: 'Supplier A', amount: 50000.0, cumulative_percentage: 66.67 },
        { id: 2, name: 'Supplier B', amount: 25000.0, cumulative_percentage: 100.0 },
      ],
    });
  }),
  ...
  http.get(`${API_URL}/analytics/tail-spend/detailed/`, () => {
    return HttpResponse.json({
      tail_suppliers: [{ id: 2, name: 'Supplier B', amount: 25000.0, transaction_count: 5 }],
      tail_count: 1,
      tail_spend: 25000.0,
      tail_percentage: 33.33,
      threshold: 50000,
  ...
  http.get(`${API_URL}/analytics/stratification/detailed/`, () => {
    return HttpResponse.json({
      ...
      bands: [
        { name: '$10K-$50K', count: 2, spend: 60000.0 },
      ],
    });
  }),

  http.get(`${API_URL}/analytics/stratification/segment/:segment/`, ({ params }) => {
    return HttpResponse.json({
  ...
  http.get(`${API_URL}/analytics/seasonality/detailed/`, () => {
    return HttpResponse.json({
      ...
      categories: [
        { id: 1, name: 'IT Equipment', peak_month: 'Jan' },
      ],
    });
  }),
  ...
  http.get(`${API_URL}/analytics/seasonality/category/:id/`, ({ params }) => {
    return HttpResponse.json({
      ...
      category_name: 'IT Equipment',
      monthly_data: [
        { month: 'Jan', spend: 15000.0 },
      ],
      suppliers: [
        { id: 1, name: 'Supplier A', spend: 15000.0 },
      ],
    });
  }),
  ...
  http.get(`${API_URL}/analytics/year-over-year/detailed/`, () => {
    return HttpResponse.json({
      years: [
        ...
        { year: 2024, total_spend: 75000.0, transaction_count: 15, growth: -85.0 },
      ],
  ...
  http.get(`${API_URL}/analytics/year-over-year/category/:id/`, ({ params }) => {
    return HttpResponse.json({
      category_id: Number(params.id),
      category_name: 'IT Equipment',
      year1_spend: 40000.0,
      ...
      growth: 12.5,
      suppliers: [
        { id: 1, name: 'Supplier A', year1_spend: 40000.0, year2_spend: 45000.0 },
      ],
    });
  }),

  http.get(`${API_URL}/analytics/year-over-year/supplier/:id/`, ({ params }) => {
    return HttpResponse.json({
      supplier_id: Number(params.id),
      supplier_name: 'Supplier A',
      year1_spend: 45000.0,
      ...
      growth: 11.1,
      categories: [
        { id: 1, name: 'IT Equipment', year1_spend: 35000.0, year2_spend: 40000.0 },
      ],
    });
  }),
  ...
  http.get(`${API_URL}/reports/templates/`, () => {
    return HttpResponse.json([
      { id: 'executive_summary', name: 'Executive Summary', report_type: 'executive_summary' },
      { id: 'spend_analysis', name: 'Spend Analysis', report_type: 'spend_analysis' },
      { id: 'supplier_performance', name: 'Supplier Performance', report_type: 'supplier_performance' },
    ]);
  }),
