...
test.describe('Spend by Category', () => {
  ...
  test('should display category breakdown', async ({ page }) => {
    ...
    const categorySection = page.locator('[data-testid="spend-by-category"], :text("category"):visible');
...
test.describe('Spend by Supplier', () => {
  ...
  test('should display supplier breakdown', async ({ page }) => {
    const supplierSection = page.locator('[data-testid="spend-by-supplier"], :text("supplier"):visible');
...
test.describe('Pareto Analysis', () => {
  ...
  test('should display Pareto chart', async ({ page }) => {
    const paretoSection = page.locator('[data-testid="pareto-analysis"], :text("pareto"):visible, :text("80/20"):visible');
...
test.describe('Tail Spend Analysis', () => {
  ...
  test('should display tail spend statistics', async ({ page }) => {
    const tailSection = page.locator('[data-testid="tail-spend"], :text("tail"):visible');
...
test.describe('Spend Stratification', () => {
  ...
  test('should display Kraljic matrix', async ({ page }) => {
    ...
    const quadrants = page.locator(':text("strategic"):visible, :text("leverage"):visible, :text("bottleneck"):visible, :text("tactical"):visible');
...
test.describe('Monthly Trend', () => {
  ...
  test('should display trend line chart', async ({ page }) => {
    const trendSection = page.locator('[data-testid="monthly-trend"], :text("trend"):visible, :text("month"):visible');
  ...
  test('should allow time period selection', async ({ page }) => {
    const periodSelector = page.getByRole('combobox', { name: /period|month|year/i });
...
test.describe('Analytics Filters', () => {
  ...
  test('should have date range filter', async ({ page }) => {
    const dateFilter = page.locator('[data-testid="date-filter"], input[type="date"], [class*="date-picker"]');
